...
var Sprite = (function (_Emitter) {
    ...
    _createClass(Sprite, [{
        ...
        value: function update() {
            ...
            if (this.right < _engine2['default'].bounds.left) {
                this.emit('off-left');
            ...
            if (this.left > _engine2['default'].bounds.right) {
                this.emit('off-right');
            ...
            if (this.bottom > _engine2['default'].bounds.top) {
                this.emit('off-top');
            ...
            if (this.top < _engine2['default'].bounds.bottom) {
            ...
            if (this.left <= _engine2['default'].bounds.left) {
                this.emit('hit-left');
            ...
            if (this.right >= _engine2['default'].bounds.right) {
                this.emit('hit-right');
            ...
            if (this.top >= _engine2['default'].bounds.top) {
                this.emit('hit-top');
            ...
            if (this.bottom <= _engine2['default'].bounds.bottom) {
