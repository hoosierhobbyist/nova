    ...
    _createClass(Polygon, [{
        ...
        value: function has(pt) {
            if ((0, _helpers.gt)((0, _helpers.dist)(pt, this.center), this.r)) {
                return false;
                    ...
                    try {
                        for (var _iterator = this.pts[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                        for (var _iterator2 = this.lns[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var ln = _step2.value;
        ...
        value: function collidesWith(other) {
            if (other instanceof Polygon) {
                ...
                try {
                    for (var _iterator4 = other.lns[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                        var ln = _step4.value;
                    ...
                    try {
                        ...
                        try {
                            for (var _iterator6 = this.lns[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                var ln = _step6.value;
